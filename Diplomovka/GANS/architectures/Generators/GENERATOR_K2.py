...
# Architektura generatora, ktory v experimetoch realizuje dvojnasobne zvacsenie rozlisenia
class GENERATOR_K2():
	...
	def get_model(self):
		...
		model.add(layers.Conv2D(128, kernel_size=(2, 2), strides=(1,1), padding='same'))
		model.add(layers.LeakyReLU())
		model.add(layers.BatchNormalization())
