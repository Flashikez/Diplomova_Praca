...
# Skript trénuje GENERATOR_K2 metódou najlepšej klasifikácie na klasifikátorovi K_FMNIST
...
trainer.start('pretrained_models/generator/','pretrained_models/discriminator/',plot_title='Tréning GENERATOR_K2 na klasifikátorovi K-FMNIST')