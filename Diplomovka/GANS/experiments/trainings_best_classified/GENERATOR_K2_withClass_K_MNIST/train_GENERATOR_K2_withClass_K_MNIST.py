...
# Skript trénuje GENERATOR_K2 metódou najlepšej klasifikácie na klasifikátorovi K_MNIST
...
trainer.start('pretrained_models/generator/','pretrained_models/discriminator/',plot_title='Tréning GENERATOR_K2 na klasifikátorovi K-MNIST , klasická chybová funkcia generátora')