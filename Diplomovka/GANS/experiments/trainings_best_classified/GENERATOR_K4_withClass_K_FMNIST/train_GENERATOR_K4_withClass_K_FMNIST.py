...
# Skript trénuje GENERATOR_K4 metódou najlepšej klasifikácie na klasifikátorovi K_FMNIST
...
trainer.start('pretrained_models/generator/','pretrained_models/discriminator/',plot_title='Tréning GENERATOR_K4  na klasifikátorovi K-MNIST')