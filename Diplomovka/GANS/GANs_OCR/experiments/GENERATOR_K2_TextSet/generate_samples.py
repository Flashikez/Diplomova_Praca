...
# Vytvorí príklady zväčšenia GANu a nejakej vybranej metódy v jednom obrázku, na porovnanie
...
progress_maker = Progress_Maker('Príklad zväčšených obrázkov Test_Set generátorom GENERATOR_K2 a metódou LANCZOS3',batch_size,num_of_batches_to_plot*4)
...
for batch in test_set:
	...
	progress_maker.add_batch(lanczos3,'LANCZOS3',clip_batch=True)
	...
	if count == num_of_batches_to_plot:
		break
progress_maker.save_progress('examples/','examples_GEN_LANCZ')
