...
generator.loadWeights('pretrained_models/generator/16/generator')
...
progress_maker = Progress_Maker('Príklad zväčšených obrázkov Test_Set generátorom #1 GENERATOR_K2 a metódou LANCZOS3',batch_size,num_of_batches_to_plot*4)
