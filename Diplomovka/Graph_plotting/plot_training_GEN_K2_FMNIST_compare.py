...
path_accuracy = ('../GANs/experiments/trainings_best_classified_percp_loss/GENERATOR_K2_withClass_K_FMNIST_Percp/log/trainlog_class_accuracy.txt')
...
path_eucl = ('../GANs/experiments/trainings_best_classified_percp_loss/GENERATOR_K2_withClass_K_FMNIST_Percp/log/EUCL.txt')
path_manh = ('../GANs/experiments/trainings_best_classified_percp_loss/GENERATOR_K2_withClass_K_FMNIST_Percp/log/MANH.txt')
path_mse = ('../GANs/experiments/trainings_best_classified_percp_loss/GENERATOR_K2_withClass_K_FMNIST_Percp/log/MSE.txt')
path_psnr = ('../GANs/experiments/trainings_best_classified_percp_loss/GENERATOR_K2_withClass_K_FMNIST_Percp/log/PSNR.txt')
path_ssim = ('../GANs/experiments/trainings_best_classified_percp_loss/GENERATOR_K2_withClass_K_FMNIST_Percp/log/SSIM.txt')
