...
path_accuracy = ('../GANs/GANs_OCR/experiments/GENERATOR_K2_TextSet/log/SSIM.txt')
...
path_eucl = ('../GANs/GANs_OCR/experiments/GENERATOR_K2_TextSet/log/EUCL.txt')
path_manh = ('../GANs/GANs_OCR/experiments/GENERATOR_K2_TextSet/log/MANH.txt')
path_mse = ('../GANs/GANs_OCR/experiments/GENERATOR_K2_TextSet/log/MSE.txt')
path_psnr = ('../GANs/GANs_OCR/experiments/GENERATOR_K2_TextSet/log/PSNR.txt')
path_ssim = ('../GANs/GANs_OCR/experiments/GENERATOR_K2_TextSet/log/SSIM.txt')
...
def make_acc(x_acc,y_acc,ax):
	...
	ax.set_title('Vývoj SSIM indexu zväčšených obrázkov generátorom GENERATOR_K2 na datasete Text_Set\n(Klasická chybová funkcia geenrátora (G_loss)) ')
	ax.set_xlabel("Počet vykonaných epochov\n1 epoch = 1250 tréningových krokov (batchov)")
