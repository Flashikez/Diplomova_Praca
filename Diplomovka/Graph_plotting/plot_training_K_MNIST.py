...
path_loss = ('../Classifiers/K_F_MNIST/training_log/MNIST/trainlog_loss.txt')
path_accuracy = ('../Classifiers/K_F_MNIST/training_log/MNIST/trainlog_accuracy.txt')
...
ax1.set_title('Vývoj hodnoty chybovej funkcie počas tréningu K-MNIST-2')
...
ax2.set_title('Vývoj presnosti klasifikátora K-MNIST-2 na testovacej množine počas tréningu')
